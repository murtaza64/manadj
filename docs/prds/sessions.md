...
- **Retention: keep forever, manual per-Session delete only.** No auto-pruning policy.
...
- Session boundary heuristics (idle-split); the viewer collapses idle instead
