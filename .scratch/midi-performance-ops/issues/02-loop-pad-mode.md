...
- 2026-07-06: verified by human ("looping works as expected") — landed on main in merge `tsyuqvkl`. LOOP pad note/lamp addresses keep their TODO(hardware-verify) until the next hands-on smoke test. Done.
