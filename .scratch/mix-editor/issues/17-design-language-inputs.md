...
Status: closed (implemented change `knyunyzv`; user-verified 2026-07-04.
Also swept dead CSS: .mixproto-play, -picker*, -body, -deckrow,
-controls*, -lanes/-lane old-layout blocks.)
