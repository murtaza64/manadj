...
class TestDownloadChain:
    def test_full_chain(
        ...
        # Only the download runs here: the waveform task its Track creation
        # enqueues (waveform-overhaul issue 02) has no handler in this worker
        # and is left pending for a capable one.
        assert processed == 1
